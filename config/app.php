...
return [
    ...
    /*
    |--------------------------------------------------------------------------
    | Hosting Batuah Server Configuration
    |--------------------------------------------------------------------------
    |
    | This section contains the server configuration for the Batuah hosting
    | environment. These values are used to establish connections to the
    | remote server for deployment and management operations.
    |
    */
